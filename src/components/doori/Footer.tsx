...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 inset-x-0 z-40 bg-[#0a1e4a] border-t border-white/10 h-14 sm:h-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 min-w-0 flex-shrink-0">
          <a
            ...
            className="text-white text-[13px] sm:text-[14px] font-bold eng tracking-wide
          ...
          <a
            ...
            className="hidden md:block text-sky-300 text-[13px] sm:text-[14px] font-semibold eng tracking-wide
        ...
        <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
          ...
          >
            ...
            <span className="hidden lg:inline text-[12px] font-bold tracking-wide">두리 블로그</span>
          </a>
          ...
          >
            ...
            <span className="hidden lg:inline text-[12px] font-bold tracking-wide">두리 TV</span>
          </a>

          <span className="hidden sm:block w-px h-3.5 bg-white/20" />

          {/* Copyright */}
          <span className="hidden sm:inline text-white/30 text-[11px] sm:text-[12px] eng tracking-wide whitespace-nowrap">
            © 2013–{year} DOORI
          </span>
        </div>
